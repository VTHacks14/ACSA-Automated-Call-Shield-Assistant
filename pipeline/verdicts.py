...
AI_SCAM           red    — set only by Layers 1-4 (audio/number-level evidence).
HUMAN_LIKELY_SCAM yellow — set only by Gemini (human voice, scam-script content).
LIKELY_HUMAN      green  — set only by Gemini (human voice, benign content).
"""
